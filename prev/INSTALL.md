...
This guide covers the preserved Go implementation under `prev/`. Commands are
shown from the repository root unless they explicitly change into `prev/`.
